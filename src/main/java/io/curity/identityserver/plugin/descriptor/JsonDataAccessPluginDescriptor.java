...
import io.curity.identityserver.plugin.data.access.json.JsonDynamicallyRegisteredClientDataAccessProvider;
...
public class JsonDataAccessPluginDescriptor implements DataAccessProviderPluginDescriptor<Configuration>
{
    ...
    public Class<? extends DynamicallyRegisteredClientDataAccessProvider> getDynamicallyRegisteredClientDataAccessProvider() {
        return JsonDynamicallyRegisteredClientDataAccessProvider.class;
    }
}
